...
ClapTrap::ClapTrap() : _name(_defaultName), _hit_points(_maxHP), _energy_points(_maxEnergyPoints), _attack_damage(_defaultAttackDamage)
{
	std::cout << "ClapTrap default constructor called" << std::endl;
}

ClapTrap::ClapTrap(std::string name) : _name(name), _hit_points(_maxHP), _energy_points(_maxEnergyPoints), _attack_damage(_defaultAttackDamage)
{
	std::cout << "ClapTrap constructor with name called" << std::endl;
}

ClapTrap::ClapTrap(const std::string name, const unsigned int hit_points, const unsigned int energy_points, const unsigned int attack_damage) : _name(name), _hit_points(hit_points), _energy_points(energy_points), _attack_damage(attack_damage)
{
