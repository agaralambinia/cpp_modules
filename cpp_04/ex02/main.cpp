...
{
	{
		...
		std::cout << BLUE_BOLD"Just ALL tests from previous exercise"RESET << std::endl;
		int test_cnt = 20;
	...
	{
		std::cout << BLUE_BOLD"Tests for ANIMAL"RESET << std::endl;
		std::cout << "All the tests are commented because these options shall not compile" << std::endl;
